...
class TestSalaryStructure(unittest.TestCase):
    def setUp(self):
        ...
        ), "default_holiday_list", "Salary Structure Test Holiday List")
    ...
    def test_amount_totals(self):
        sal_slip = frappe.get_value(
            "Salary Slip", {"employee_name": "test_employee@salary.com"})
        if not sal_slip:
            sal_slip = make_salary_slip_from_salary_structure(employee=frappe.get_value(
                "Employee", {"employee_name": "test_employee@salary.com"}))
            self.assertEquals(sal_slip.get("salary_structure"),
    ...
    def test_whitespaces_in_formula_conditions_fields(self):
        ...
        salary_structure = frappe.get_doc(
            "Salary Structure", "Salary Structure Sample")
...
def make_salary_slip_from_salary_structure(employee):
    ...
    sal_slip.employee_name = frappe.get_value(
